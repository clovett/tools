    ...
    class XslCommandLine
    {
        ...
        void Transform(string filename)
        {
            ...
            if (this.echo)
            {
                ...
                transform.Transform(filename, null, ms);
                var bytes = ms.ToArray();
                // skip UTF-8 BOM.
                Console.WriteLine(System.Text.Encoding.UTF8.GetString(bytes, 3, bytes.Length - 3));
            }
            else
            {
        ...
        public static void PrintUsage()
        {
            ...
            Console.WriteLine("  -e                 print output to stdout instead of a file");
