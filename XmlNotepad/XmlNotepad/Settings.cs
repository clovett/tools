	...
	public class Settings : IDisposable
	{
        ...
        string ConvertToString(object value) {
            if (value is Uri) {
                ...
                throw new ApplicationException(string.Format("Type converted for type '{0}' not found", value.GetType().FullName));
            }
        }
        ...
        object ConvertToType(string value, Type type) {
            if (type == typeof(Uri)) {
                ...
                throw new ApplicationException(string.Format("Type converted for type '{0}' not found", type.FullName));
            }
        }
        ...
        private void watcher_Changed(object sender, FileSystemEventArgs e) {
            ...
            if (e.ChangeType == WatcherChangeTypes.Changed && this.timer == null) {
                this.timer = new System.Threading.Timer(new TimerCallback(OnDelay), this, 0, 1000);                
            }
        }
        ...
        public string GetPersistentFileName(Uri uri) {
            ...
            try {
                ...
                foreach (string key in variables.Keys) {
                    ...
                    string relPath = baseUri.MakeRelative(uri);
                    if (string.Compare(path, relPath, StringComparison.CurrentCultureIgnoreCase) != 0) {
