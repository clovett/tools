...
namespace XmlNotepad {
    ...
    public class TextEditorOverlay : IDisposable {
        ...
        public TextEditorOverlay(Control parent) {
            ...
            this.textEditor.Name = parent.Name + "Editor";
        ...
        public void BeginEdit(string text, IIntellisenseProvider provider, EditMode mode, Color color) {
            ...
            switch (mode) {
                case EditMode.Value:
                    ...
                    values = provider.GetExpectedValues();
                    break;
                case EditMode.Name:
                    values = provider.GetExpectedNames();
                    break;
            }
            ...
            if (builder != null || (values != null && values.Length > 0)) {
                cset.BeginEdit(values, this.schemaType);                
            } 
        }
        ...
        void AdjustBounds(string text, Graphics g, TextEditorLayoutEventArgs args) {
            ...
            SizeF size = g.MeasureString(text, this.parent.Font, this.parent.Width, StringFormat.GenericTypographic);
            ...
            r.Height = Math.Min((this.parent.Height * 2) / 3, h); // no more than 2/3rd of the window.
            if (AutoSize) {
        ...
        void SetEditorBounds(TextEditorLayoutEventArgs args) {
            ...
            using (g) {
                AdjustBounds(this.currentEditor.Text, g, args);
            }
            Rectangle r = args.PreferredBounds;
            ...
            //Debug.WriteLine("EditorBounds:"+r.ToString());
    ...
    class CompletionSet : Control {
        ...
        public void BeginEdit(string[] values, XmlSchemaType type) {
            this.type = type;
            ...
            if (values != null) {
                foreach (string s in values) {
                    int i = this.listBox.Items.Add(s);
        ...
        public void EndEdit(bool cancel) {
            if (!cancel && this.listBox.SelectedItem != null && this.Visible) {
