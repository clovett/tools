...
namespace XmlNotepad {
    ...
    public class TreeView : UserControl {
        ...
        public void HandleKeyDown(KeyEventArgs e) {
            ...
            if (e.Modifiers != 0 && !isLetterOrDigit)
                return;
        ...
        public bool BeginEdit(string value) {
            ...
            if (this.editable && sel != null && sel.IsLabelEditable) {
                ...
                this.editor.BeginEdit(text, provider, EditMode.Name, sel.ForeColor);
                return true;
            }
            return false;
        }
        ...
        public void EndUpdate() {
            this.updateDepth--;
            if (updateDepth == 0 && this.layoutInvalid) {
                this.PerformLayout();
                Invalidate();
            }
        }
