...
namespace Microsoft.OperationsManager.Test.Infrastructure
{
    ...
    /// <summary>
    /// Differencing options, use these to adjust the comparison.
    /// </summary>
    public enum MomXmlDiffOptions
    {
        /// <summary>
        /// Use default differencing.
        /// </summary>
        None = XmlDiffOptions.None,

        /// <summary>
        /// Ignore  differences due to Child Order
        /// </summary>
        IgnoreChildOrder = XmlDiffOptions.IgnoreChildOrder,

        /// <summary>
        /// Ignore  differences due to Comments
        /// </summary>
        IgnoreComments = XmlDiffOptions.IgnoreComments,

        /// <summary>
        /// Ignore  differences due to Programming Instructions
        /// </summary>
        IgnorePI = XmlDiffOptions.IgnorePI,

        /// <summary>
        /// Ignore differences due to Whitespace
        /// </summary>
        IgnoreWhitespace = XmlDiffOptions.IgnoreWhitespace,

        /// <summary>
        /// Ignore differences due to Namespaces
        /// </summary>
        IgnoreNamespaces = XmlDiffOptions.IgnoreNamespaces,

        /// <summary>
        /// Ignore differences due to Prefixes
        /// </summary>
        IgnorePrefixes = XmlDiffOptions.IgnorePrefixes,

        /// <summary>
        /// Ignore differences due to Xml Declarations
        /// </summary>
        IgnoreXmlDecl = XmlDiffOptions.IgnoreXmlDecl,

        /// <summary>
        /// Ignore  differences due to DTD schema statements
        /// </summary>
        IgnoreDtd = XmlDiffOptions.IgnoreDtd,
    }
    ...
    public sealed class XmlDiffView
    {
        ...
        /// Background colors
        /// </summary>
        private static readonly string[] HtmlBgColor = 
        {
        ...
        /// Foreground colors
        /// </summary>
        private static readonly string[] HtmlFgColor = 
        {
            // Match    = 0
            "black",
        ...
        /// <param name="displayInXmlNotepad">Use header suitable for XmlNotepad application</param>
        /// <param name="options">comparison filtering options</param>
        /// <returns>Differences were not found after filtering.</returns>
        public bool DifferencesSideBySideAsHtml(
            string sourceXmlFile,
        ...
        {
            this.viewDocument.DrawHtml(new XmlTextWriter(htmlOutput), 10);
        }
        ...
        /// <summary>
        ///    Translates string representation of XmlDiff options into MomXmlDiffOptions enum.
        /// </summary>
        ...
        private static MomXmlDiffOptions ParseOptions(string options)
        {
            if (options == null)
                throw new ArgumentNullException("options");

            if (options == MomXmlDiffOptions.None.ToString())
                return MomXmlDiffOptions.None;
            else
            {
                MomXmlDiffOptions optionsEnum = MomXmlDiffOptions.None;
                ...
                while (i < options.Length)
                {
                    ...
                    switch (opt)
                    {
                        case "IgnoreChildOrder": optionsEnum |= MomXmlDiffOptions.IgnoreChildOrder; 
                            break;
                        case "IgnoreComments": optionsEnum |= MomXmlDiffOptions.IgnoreComments; 
                            break;
                        case "IgnoreNamespaces": optionsEnum |= MomXmlDiffOptions.IgnoreNamespaces; 
                            break;
                        case "IgnorePI": optionsEnum |= MomXmlDiffOptions.IgnorePI; 
                            break;
                        case "IgnorePrefixes": optionsEnum |= MomXmlDiffOptions.IgnorePrefixes; 
                            break;
                        case "IgnoreWhitespace": optionsEnum |= MomXmlDiffOptions.IgnoreWhitespace; 
                            break;
                        case "IgnoreXmlDecl": optionsEnum |= MomXmlDiffOptions.IgnoreXmlDecl; 
                            break;
                        case "IgnoreDtd": optionsEnum |= MomXmlDiffOptions.IgnoreDtd; 
                            break;
                        default:
        ...
        /// <param name="changedXmlFile">actual file</param>
        /// <param name="fragment">xml data fragment</param>
        /// <param name="displayInXmlNotepad">Output to be 
        /// displayed in XmlNotepad</param>
        /// <param name="options">Comparison options</param>
            ...
            TextWriter resultHtml)
        {
            ...
            if (displayInXmlNotepad)
            {
                this.SideBySideXmlNotepadHeader(
                    sourceXmlFile,
                    changedXmlFile,
                    identicalData,
                    resultHtml);
            ...
            TextWriter resultHtml)
        {
            ...
            resultHtml.WriteLine("<body><h3 style='font-family:Arial'>Xml differences view</h3>");
            resultHtml.WriteLine("<table border='0'>");
            resultHtml.WriteLine("<tr><td><table border='0'>");
            resultHtml.Write("<tr><td colspan='2' align='center'><b>Legend:</b> <font style='background-color: yellow'" +
            ...
            resultHtml.Write("<tr><td title='" + System.IO.Path.GetDirectoryName(sourceXmlFile) + "'><b> File in editor : ");
            resultHtml.Write(System.IO.Path.GetFileName(sourceXmlFile));
            resultHtml.Write("</b></td><td title='" + System.IO.Path.GetDirectoryName(changedXmlFile) + "'><b> File to compare : ");
            resultHtml.Write(System.IO.Path.GetFileName(changedXmlFile));
            resultHtml.Write("</b></td></tr>");
            ...
            {
                resultHtml.WriteLine("<tr><td colspan='2' align='middle'>" +
        ...
        private void PreprocessDiffgram(XmlDocument diffgramDoc)
        {
            ...
            MomXmlDiffOptions options = ParseOptions(optionsAttr);
            this.ignoreChildOrder = (((int)options & (int)
                (MomXmlDiffOptions.IgnoreChildOrder)) > 0);
            this.ignoreComments = (((int)options &
                (int)(MomXmlDiffOptions.IgnoreComments)) > 0);
            this.ignorePI = (((int)options &
                (int)(MomXmlDiffOptions.IgnorePI)) > 0);
            this.ignoreWhitespace = (((int)options &
                (int)(MomXmlDiffOptions.IgnoreWhitespace)) > 0);
            this.ignoreNamespaces = (((int)options &
                (int)(MomXmlDiffOptions.IgnoreNamespaces)) > 0);
            this.ignorePrefixes = (((int)options &
                (int)(MomXmlDiffOptions.IgnorePrefixes)) > 0);
            this.ignoreDtd = (((int)options &
                (int)(MomXmlDiffOptions.IgnoreDtd)) > 0);
        ...
        /// <param name="identicalData">Data is identical</param>
        /// <param name="resultHtml">Output file</param>
        private void SideBySideHtmlHeader(
            string sourceXmlFile,
            string changedXmlFile,
            bool identicalData,
            TextWriter resultHtml)
