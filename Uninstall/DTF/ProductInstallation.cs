    ...
    public class ProductInstallation : Installation
    {
        ...
        public static IEnumerable<ProductInstallation> GetRelatedProducts(string upgradeCode)
        {
            return new Enumerable<ProductInstallation>(
                ProductInstallation.EnumRelatedProducts, new object[] { upgradeCode });
        }

        private static IEnumerator<ProductInstallation> EnumRelatedProducts(object[] args)
        {
            string upgradeCode = (string) args[0];
        ...
        {
            return new Enumerable<ProductInstallation>(
                ProductInstallation.EnumProducts, new object[] { productCode, userSid, context });
        }

        private static IEnumerator<ProductInstallation> EnumProducts(object[] args)
        {
            string productCode = (string) args[0];
            string userSid = (string) args[1];
            UserContexts context = (UserContexts) args[2];
        ...
        public IEnumerable<FeatureInstallation> Features
        {
            get
            {
                return new Enumerable<FeatureInstallation>(
                    this.EnumFeatures, null);
            }
        }

        private IEnumerator<FeatureInstallation> EnumFeatures(object[] args)
        {
