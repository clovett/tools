...
namespace DesktopBackgroundSlideshow
{
    ...
    {
        public static bool SetFromFile(string path)
        {
            ...
            return NativeMethods.SystemParametersInfo(SET_DESKTOP_BACKGROUND, 0, path, UPDATE_INI_FILE | SEND_WINDOWS_INI_CHANGE);
        }
