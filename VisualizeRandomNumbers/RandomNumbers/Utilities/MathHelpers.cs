...
namespace RandomNumbers.Utilities
{
    public static class MathHelpers
    {
        ...
        /// </summary>
        public static double Covariance(IEnumerable<DataValue> pts)
        {
            double xsum = 0;
            double ysum = 0;
            double count = 0;
            foreach (DataValue d in pts)
            {
                xsum += d.X;
                ysum += d.Y;
                count++;
        ...
        public static void LinearRegression(IEnumerable<DataValue> pts, out double a, out double b)
        {
