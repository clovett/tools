...
namespace PublishHelp
{
    class Program
    {
        ...
        {
            Console.WriteLine("Usage: PublishHelp <Section> <targetdir>");
            Console.WriteLine("Publishes content of the given OneNote Section as Markdown to the target directory");
            Console.WriteLine("OneNote must be running and notebook containing the <Section> must be open.");
        }
