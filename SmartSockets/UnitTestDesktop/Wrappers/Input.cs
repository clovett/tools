namespace UnitTestDesktop
{
    ...
    public static class Input {
        ...
        public static void SendMouseScrollWheel(Point pt, MouseWheel mwRotation, System.Windows.Input.Key key)
        {
            ...
            if (MouseWheel.Forward_ZoomIn == mwRotation)
            {
                mouseData = 120;
            }

            if (MouseWheel.Backward_ZoomOut == mwRotation)
            {
                mouseData = -120;
            }
        ...
        internal static double ConvertToDeviceIndependentPixels(double pixels)
        {
        ...
        internal static Point ConvertToDeviceIndependentPoint(System.Drawing.Point gdiPoint)
        {
            return new Point(ConvertToDeviceIndependentPixels(gdiPoint.X), ConvertToDeviceIndependentPixels(gdiPoint.Y));
        }

        internal static System.Drawing.Point ConvertFromDeviceIndependentPoint(Point wpfPoint)
        {
            return new System.Drawing.Point(ConvertFromDeviceIndependentPixels(wpfPoint.X), ConvertFromDeviceIndependentPixels(wpfPoint.Y));
        }
    }
}
