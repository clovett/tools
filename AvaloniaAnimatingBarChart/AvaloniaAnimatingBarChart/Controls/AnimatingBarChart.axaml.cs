...
namespace AvaloniaAnimatingBarChart.Controls
{
    ...
    public partial class AnimatingBarChart : UserControl
    {
        ...
        private static void OnDataChanged(Interactive interactive, AvaloniaPropertyChangedEventArgs args)
        {
            if (interactive is AnimatingBarChart chart)
            {
                chart.OnDataChanged(args.NewValue);
            }
        }
        ...
        public static readonly StyledProperty<ChartData> ChartDataProperty = AvaloniaProperty.Register<AnimatingBarChart, ChartData>("ChartData");
